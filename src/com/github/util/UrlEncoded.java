...
import com.github.util.Utf8Appendable.NotUtf8Exception;
...
{
 private static final Logger LOG = Logger.getLogger(UrlEncoded.class.getName());
         ...
         for (int i=0;i<content.length();i++)
         {
             ...
             switch (c)
             {
               case '&':
                   ...
                   {
                       LOG.warning("maxFormKeys limit exceeded keys>"+maxKeys);
                       return;
                   }
                   break;
               case '=':
